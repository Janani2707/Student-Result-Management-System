...
for($i=0;$i<count($mark);$i++){
    $mar=$mark[$i];
  $sid=$sid1[$i];
$sql="INSERT INTO  tblresult(StudentId,ClassId,SubjectId,marks,cgpa) VALUES(:studentid,:class,:sid,:marks,:cgpa)";
...
<div class="col-sm-10">
<input type="text" name="cgpa" class="form-control" id="cgpa" required="required" onChange="getresult(this.values);">
</div>
</div>
