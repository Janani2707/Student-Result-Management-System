...
$query->execute();
$sql="update tblresult  set cgpa=:cgpa where id=:iid ";
$query = $dbh->prepare($sql);
...
$ret = "SELECT tblstudents.StudentName,tblresult.cgpa,tblclasses.ClassName,tblclasses.Section from tblresult join tblstudents on tblresult.StudentId=tblresult.StudentId join tblsubjects on tblsubjects.id=tblresult.SubjectId join tblclasses on tblclasses.id=tblstudents.ClassId where tblstudents.StudentId=:stid limit 1";
